...
export default function Footer({ adhigaramData = {} }: FooterProps) {
    ...
    return (
        <footer className="relative w-full mt-auto pt-20 pb-10 overflow-hidden bg-slate-50 dark:bg-slate-950/30">
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16 border-t border-b border-gray-200 dark:border-white/5 py-12">
                    ...
                    {/* Columns 2, 3, 4: Paals */}
                    {sortedKeys.map((paal) => (
                        <div key={paal} className="flex flex-col items-center md:items-start space-y-4">
                            ...
                            <ul className="space-y-2 w-full">
                                {paalData[paal].map((adhigaram, idx) => (
                                    <li key={idx} className="flex items-center justify-center md:justify-start group">
                                        <Link
